...
export const themes: Record<ThemeMode, Theme> = {
    dark: {
        ...
        textPrimary: "#ede9e3",
        textSecondary: "rgba(237, 233, 227, 0.7)",
        textMuted: "rgba(237, 233, 227, 0.45)",
    ...
    light: {
        ...
        textMuted: "rgba(42, 37, 33, 0.72)",
        textDisabled: "rgba(42, 37, 33, 0.45)",
        accentPrimary: "#b8706e",
        accentPrimaryHover: "#a6605e",
        accentPrimaryMuted: "rgba(184, 112, 110, 0.12)",
        accentPrimaryBorder: "rgba(184, 112, 110, 0.35)",
        accentSecondary: "#5a8679",
        accentSecondaryMuted: "rgba(90, 134, 121, 0.15)",
        accentSecondaryBorder: "rgba(90, 134, 121, 0.25)",
