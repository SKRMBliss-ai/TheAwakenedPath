...
export const LESSONS: Lesson[] = [
  ...
  },
  {
    id: 'ep4-part1',
    badge: '4·1',
    kicker: 'Episode 4 · Part 1 — See Your Escapes',
    title: 'Why Does It Hurt So Much? (The Truth About Stored Emotions)',
    desc: "Michael Singer & Eckhart Tolle's deep insights into how resisted emotions don't vanish — they stay stored inside the body as unreleased emotional energy.",
    videoId: '0nxN9fQfVKU',
    week: 0,
    free: true,
  },
  {
    id: 'ep4-part2',
    badge: '4·2',
    kicker: 'Episode 4 · Part 2 — See Your Escapes',
    title: 'The Automatic Phone Reaching Reflex (Relief vs Release)',
    desc: 'Notice what happens the second discomfort arises — phone, work, shopping — and why avoidance never truly sets us free.',
    videoId: 'SajZXFmmDmQ',
    week: 0,
    free: true,
  },
  {
    id: 'ep4-part3',
    badge: '4·3',
    kicker: 'Episode 4 · Part 3 — See Your Escapes',
    title: 'Dissolving the Need to Escape (Witness Consciousness)',
    desc: 'How to stay centered when the urge to escape arises, resting as the witness by the river.',
    videoId: 'a2SxdLkKrR0',
    week: 0,
    free: true,
  },
  {
    id: 'ep4-meditation',
    badge: '4·M',
    kicker: 'Episode 4 · Guided Meditation',
  ...
  },
  {
    id: 'ep5-part1',
    badge: '5·1',
    kicker: 'Episode 5 · Part 1 — See Your Masks',
    title: 'Why We Keep Trying to Prove Ourselves (Part 1)',
  ...
  },
  {
    id: 'ep5-part2',
    badge: '5·2',
    kicker: 'Episode 5 · Part 2 — See Your Masks',
    title: 'The Mask of Achievement & Approval (Part 2)',
    desc: 'Understanding why we construct ego masks to seek approval and how to stop performing for validation.',
    videoId: null,
    week: 0,
  },
  {
  ...
  },
  {
    ...
    title: 'Seeing Through Your Masks (Guided Meditation)',
    desc: 'A deep guided meditation on releasing ego masks, softening performance pressure, and resting in authentic presence.',
    videoId: null,
    week: 0,
  },
  {
...
const MODULE_GROUPS: { id: string; kicker: string; title: string; lessonIds: string[] }[] = [
  ...
  },
  {
    ...
    lessonIds: ['ep4-part1', 'ep4-part2', 'ep4-part3', 'ep4-meditation'],
  },
  {
    id: 'ep5',
    kicker: 'Episode 5',
    title: 'Episode 5 — See Your Masks',
    lessonIds: ['ep5-part1', 'ep5-part2', 'ep5-part3', 'ep5-meditation'],
  },
  {
    id: 'ep6',
    kicker: 'Episode 6',
