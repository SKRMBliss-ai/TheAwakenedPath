...
export const themes: Record<ThemeMode, Theme> = {
    ...
    light: {
        ...
        accentPrimary: "#3D8B7A",
        accentPrimaryHover: "#357A6B",
        accentPrimaryMuted: "rgba(61, 139, 122, 0.12)",
        accentPrimaryBorder: "rgba(61, 139, 122, 0.35)",
        accentSecondary: "#3D8B7A",
        accentSecondaryMuted: "rgba(61, 139, 122, 0.15)",
        accentSecondaryBorder: "rgba(61, 139, 122, 0.25)",
        glowCyan: "rgba(61, 139, 122, 0.1)",
        glowGold: "rgba(196, 149, 106, 0.1)",
        orbFill: "radial-gradient(circle at 40% 35%, rgba(61,139,122,0.20) 0%, rgba(40,110,98,0.14) 60%, rgba(30,90,80,0.05) 100%)",
        orbText: "rgba(60,40,50,0.75)",
        orbParticle: "rgba(61,139,122,0.3)",
        orbShadow: "0 8px 40px rgba(61,139,122,0.08)",
        ...
        chipSelectedBg: "rgba(61, 139, 122, 0.1)",
        chipSelectedBorder: "rgba(61, 139, 122, 0.35)",
        quoteBg: "rgba(61, 139, 122, 0.06)",
        quoteBorder: "rgba(61, 139, 122, 0.3)",
        navActiveBg: "rgba(61, 139, 122, 0.1)",
        navActiveBorder: "rgba(61, 139, 122, 0.35)",
