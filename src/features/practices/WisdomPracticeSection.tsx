...
const WISDOM_PRACTICES = [
  {
    ...
    color: '#B8973A',
    imageLight: VoiceService.getStorageUrl('PracticeRoom/WisdomUntethered/q1_light.webp'),
    imageDark: VoiceService.getStorageUrl('PracticeRoom/WisdomUntethered/q1_dark.webp'),
    steps: [
  ...
  },
  {
    ...
    duration: '2 min',
    color: '#9575CD',
    imageLight: VoiceService.getStorageUrl('PracticeRoom/WisdomUntethered/q2_light.webp'),
    imageDark: VoiceService.getStorageUrl('PracticeRoom/WisdomUntethered/q2_dark.webp'),
    steps: [
  ...
  },
  {
    ...
    color: '#3A8BBF',
    imageLight: VoiceService.getStorageUrl('PracticeRoom/WisdomUntethered/q3_light.webp'),
    imageDark: VoiceService.getStorageUrl('PracticeRoom/WisdomUntethered/q3_dark.webp'),
    triggerCount: 3,
    triggers: [
  ...
  },
  {
    ...
    duration: '1 min',
    color: '#FF6F61',
    imageLight: VoiceService.getStorageUrl('PracticeRoom/WisdomUntethered/q4_light.webp'),
    imageDark: VoiceService.getStorageUrl('PracticeRoom/WisdomUntethered/q4_dark.webp'),
    steps: [
  ...
  },
  {
    ...
    duration: '3 min',
    color: '#2E9E7A',
    imageLight: VoiceService.getStorageUrl('PracticeRoom/WisdomUntethered/q5_light.webp'),
    imageDark: VoiceService.getStorageUrl('PracticeRoom/WisdomUntethered/q5_dark.webp'),
    steps: [
  ...
  },
  {
    ...
    duration: '2 min',
    color: '#EC4899',
    imageLight: VoiceService.getStorageUrl('PracticeRoom/WisdomUntethered/q6_light.webp'),
    imageDark: VoiceService.getStorageUrl('PracticeRoom/WisdomUntethered/q6_dark.webp'),
    steps: [
  ...
  },
  {
    ...
    duration: '1 min',
    color: '#F59E0B',
    imageLight: VoiceService.getStorageUrl('PracticeRoom/WisdomUntethered/q7_light.webp'),
    imageDark: VoiceService.getStorageUrl('PracticeRoom/WisdomUntethered/q7_dark.webp'),
    steps: [
  ...
  },
  {
    id: 'question8',
    questionNum: 8,
    questionTitle: 'Let Go Now or Fall',
    practiceName: 'The Instant Release',
    practiceDesc: 'When you feel the urge to resist reality — relax and release instantly.',
    duration: 'Ongoing',
    color: '#EF4444',
    imageLight: VoiceService.getStorageUrl('PracticeRoom/WisdomUntethered/q8_light.webp'),
    imageDark: VoiceService.getStorageUrl('PracticeRoom/WisdomUntethered/q8_dark.webp'),
    steps: [
      'Feel the physical sensation of "no" or resistance in your chest or throat.',
      'Recognize that this resistance is what causes the fall into suffering.',
      'Instead of fighting the external situation, relax the internal resistance.',
      'Let the energy move through. You are essentially letting go before you fall.',
    ],
  },
  {
    id: 'question9',
    questionNum: 9,
    questionTitle: 'The Secret of the Middle Way',
    practiceName: 'Resting in the Center',
    practiceDesc: 'Stay in the center, between the attraction and the aversion.',
    duration: '5 min',
    color: '#10B981',
    imageLight: VoiceService.getStorageUrl('PracticeRoom/WisdomUntethered/q9_light.webp'),
    imageDark: VoiceService.getStorageUrl('PracticeRoom/WisdomUntethered/q9_dark.webp'),
    steps: [
      'Sit quietly and notice anything you currently want or are trying to avoid.',
      'Neither follow the "want" nor push away the "don\'t want."',
      'Take your seat exactly in the middle — the point of pure balance.',
      'Notice that in this center, there is no drama. Only peace.',
    ],
  },
];
