...
const WISDOM_PRACTICES = [
  ...
  },
  {
    ...
    duration: 'Ongoing',
    color: '#EF4444',
    imageLight: VoiceService.getStorageUrl('PracticeRoom/WisdomUntethered/q8_light.png'),
    imageDark: VoiceService.getStorageUrl('PracticeRoom/WisdomUntethered/q8_dark.png'),
    steps: [
  ...
  },
  {
    ...
    duration: '5 min',
    color: '#10B981',
    imageLight: VoiceService.getStorageUrl('PracticeRoom/WisdomUntethered/q9_light.png'),
    imageDark: VoiceService.getStorageUrl('PracticeRoom/WisdomUntethered/q9_dark.png'),
    steps: [
