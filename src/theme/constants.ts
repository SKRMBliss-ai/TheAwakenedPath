...
export const themes: Record<ThemeMode, Theme> = {
    ...
    light: {
        ...
        textMuted: "rgba(54, 47, 43, 0.78)",
        textDisabled: "rgba(54, 47, 43, 0.50)",
        ...
        borderDefault: "rgba(45, 40, 35, 0.32)",
        borderSubtle: "rgba(45, 40, 35, 0.12)",
        borderGlass: "rgba(45, 40, 35, 0.10)",
