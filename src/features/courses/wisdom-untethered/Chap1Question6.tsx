...
const ALL_SLIDES = Array.from({ length: 14 }, (_, i) => `slide${i + 1}`);
...
export function Chap1Question6({ onOpenJournal }: Chap1Question6Props) {
  ...
  return (
    <div className={cn(styles.container, "scroll-container")} ref={containerRef} style={{ height: '100%', overflowY: 'auto' }}>
        ...
        <div className={styles.slideGrid}>
          <div className={styles.imgWrap}>
            ...
            <div className={styles.imageContainer}>
              <img src={SLIDE_IMAGES["slide1"]} alt="The hook" onClick={() => openLightbox(0)} className={styles.slideImg} />
            </div>
          </div>
      ...
      <section className={styles.slide} data-section="2">
        <div className={cn(styles.slideGrid, styles.flip)}>
          <div className={styles.imgWrap}>
            ...
            <div className={styles.imageContainer}>
              <img src={SLIDE_IMAGES["slide2"]} alt="The process" onClick={() => openLightbox(1)} className={styles.slideImg} />
            </div>
          </div>
          <div className={styles.slideContent}>
      ...
      <section className={styles.slide} data-section="3">
        <div className={styles.slideGrid}>
          <div className={styles.imgWrap}>
            ...
            <div className={styles.imageContainer}>
              <img src={SLIDE_IMAGES["slide3"]} alt="The realization" onClick={() => openLightbox(2)} className={styles.slideImg} />
            </div>
          </div>
          <div className={styles.slideContent}>
      ...
      <section className={styles.slide} data-section="4">
        <div className={cn(styles.slideGrid, styles.flip)}>
          <div className={styles.imgWrap}>
            ...
            <div className={styles.imageContainer}>
              <img src={SLIDE_IMAGES["slide4"]} alt="The teaching" onClick={() => openLightbox(3)} className={styles.slideImg} />
            </div>
          </div>
          <div className={styles.slideContent}>
      ...
      <section className={styles.slide} data-section="5">
        <div className={styles.slideGrid}>
          <div className={styles.imgWrap}>
            ...
            <div className={styles.imageContainer}>
              <img src={SLIDE_IMAGES["slide5"]} alt="The analogy" onClick={() => openLightbox(4)} className={styles.slideImg} />
            </div>
          </div>
          <div className={styles.slideContent}>
      ...
      <section className={styles.slide} data-section="6">
        <div className={cn(styles.slideGrid, styles.flip)}>
          <div className={styles.imgWrap}>
            ...
            <div className={styles.imageContainer}>
              <img src={SLIDE_IMAGES["slide6"]} alt="The practice" onClick={() => openLightbox(5)} className={styles.slideImg} />
            </div>
          </div>
          <div className={styles.slideContent}>
      ...
      <section className={styles.slide} data-section="7">
        <div className={styles.slideGrid}>
          <div className={styles.imgWrap}>
            ...
            <div className={styles.imageContainer}>
              <img src={SLIDE_IMAGES["slide7"]} alt="The weight" onClick={() => openLightbox(6)} className={styles.slideImg} />
            </div>
          </div>
          <div className={styles.slideContent}>
      ...
      <section className={styles.slide} data-section="8">
        <div className={cn(styles.slideGrid, styles.flip)}>
          <div className={styles.imgWrap}>
            ...
            <div className={styles.imageContainer}>
              <img src={SLIDE_IMAGES["slide8"]} alt="Narrative" onClick={() => openLightbox(7)} className={styles.slideImg} />
            </div>
          </div>
          <div className={styles.slideContent}>
      ...
      <section className={styles.slide} data-section="9">
        <div className={styles.slideGrid}>
          <div className={styles.imgWrap}>
            ...
            <div className={styles.imageContainer}>
              <img src={SLIDE_IMAGES["slide9"]} alt="The shift" onClick={() => openLightbox(8)} className={styles.slideImg} />
            </div>
          </div>
          <div className={styles.slideContent}>
      ...
      <section className={styles.slide} data-section="10">
        <div className={cn(styles.slideGrid, styles.flip)}>
          <div className={styles.imgWrap}>
            ...
            <div className={styles.imageContainer}>
              <img src={SLIDE_IMAGES["slide10"]} alt="Breath" onClick={() => openLightbox(9)} className={styles.slideImg} />
            </div>
          </div>
          <div className={styles.slideContent}>
      ...
      <section className={styles.slide} data-section="11">
        <div className={styles.slideGrid}>
          <div className={styles.imgWrap}>
            ...
            <div className={styles.imageContainer}>
              <img src={SLIDE_IMAGES["slide11"]} alt="Visualization" onClick={() => openLightbox(10)} className={styles.slideImg} />
            </div>
          </div>
          <div className={styles.slideContent}>
      ...
      <section className={styles.slide} data-section="12">
        <div className={cn(styles.slideGrid, styles.flip)}>
          <div className={styles.imgWrap}>
            ...
            <div className={styles.imageContainer}>
              <img src={SLIDE_IMAGES["slide12"]} alt="Softening" onClick={() => openLightbox(11)} className={styles.slideImg} />
            </div>
          </div>
          <div className={styles.slideContent}>
      ...
      <section className={styles.slide} data-section="13">
        <div className={styles.slideGrid}>
          <div className={styles.imgWrap}>
            ...
            <div className={styles.imageContainer}>
              <img src={SLIDE_IMAGES["slide13"]} alt="The self" onClick={() => openLightbox(12)} className={styles.slideImg} />
            </div>
          </div>
          <div className={styles.slideContent}>
      ...
      <section className={styles.slide} data-section="14">
        <div className={cn(styles.slideGrid, styles.flip)}>
          <div className={styles.imgWrap}>
            ...
            <div className={styles.imageContainer}>
              <img src={SLIDE_IMAGES["slide14"]} alt="Integration" onClick={() => openLightbox(13)} className={styles.slideImg} />
            </div>
          </div>
          <div className={styles.slideContent}>
      ...
      {/* --- CLOSING --- */}
      <section className={styles.closing} data-section="16">
